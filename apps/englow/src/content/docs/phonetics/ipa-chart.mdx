...
| **/ɚ/** | R-Schwa | **mother**, *doctor, butter* | Unstressed vowel with gentle R curl |
...
👉 *For step-by-step video drills on TH, W vs V, R sounds, and the Flap T, explore [Consonants & Challenging Sounds](/phonetics/consonants/).*
...
3. **[Diphthongs & Glides](/phonetics/diphthongs/)**: Learn the smooth physical glide of diphthongs and R combinations.
...
<div class="references-box">
  <div class="references-title">
    ...
    <span>Interactive Online Phonetic Tools</span>
  </div>
  <ul class="references-list">
    <li><a href="https://grammarway.com/phonetics" target="_blank" rel="noopener noreferrer">GrammarWay: English Phonetics & Sounds Overview</a> — full phonetic breakdown explaining symbols, stress markers, and articulation mechanics.</li>
    <li><a href="https://www.ipachart.com/" target="_blank" rel="noopener noreferrer">Interactive IPA Chart (ipachart.com)</a> — clickable audio chart: click any IPA symbol to hear pristine studio audio samples.</li>
    <li><a href="https://dictionary.cambridge.org/" target="_blank" rel="noopener noreferrer">Cambridge English Dictionary</a> — official phonetic transcriptions and native audio pronunciation for every word.</li>
    <li><a href="https://youglish.com/" target="_blank" rel="noopener noreferrer">YouGlish English Pronunciation</a> — listen to real native speakers pronouncing any sound or word in natural speeches.</li>
  </ul>
</div>
