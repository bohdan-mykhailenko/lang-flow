...
<div class="references-box">
  <div class="references-title">
    ...
    <span>Interactive Online References & Pronunciation Tools</span>
  </div>
  <ul class="references-list">
    <li><a href="https://grammarway.com/reading-rules" target="_blank" rel="noopener noreferrer">GrammarWay: English Reading & Consonant Rules</a> — complete reference for silent consonants, digraphs (th, sh, ch, ph, wh), and pronunciation patterns.</li>
    <li><a href="https://grammarway.com/phonetics" target="_blank" rel="noopener noreferrer">GrammarWay: English Phonetics & Sounds</a> — comprehensive chart of phonetic symbols with articulatory explanations and examples.</li>
    <li><a href="https://www.ipachart.com/" target="_blank" rel="noopener noreferrer">IPAChart.com Interactive Soundboard</a> — interactive audio matrix covering all English and international consonant phonemes.</li>
    <li><a href="https://youglish.com/" target="_blank" rel="noopener noreferrer">YouGlish Pronunciation Search</a> — real-world video clips illustrating natural consonant pronunciation in continuous speech.</li>
  </ul>
</div>
